  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Pomodoro suits grinding: problem sets, flashcards, drafting. For genuinely collaborative work such as whiteboarding a proof or a group project, pick a discussion vibe instead and let the conversation flow. The technique is a tool, not a religion.',
        ],
      },
    ],
  },

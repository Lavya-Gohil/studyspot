      ...
      <div className="flex items-center gap-2 pt-1">
        {requestStatus === 'approved' ? (
          ...
          <Link
            ...
            className="flex-1 h-10 rounded-md bg-accent-primary hover:bg-accent-hover text-white text-sm font-medium flex items-center justify-center transition-colors"
          >
            View session →
          </Link>
        ) : (
          <button
            ...
            className="flex-1 h-10 rounded-md bg-accent-primary hover:bg-accent-hover text-white text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >

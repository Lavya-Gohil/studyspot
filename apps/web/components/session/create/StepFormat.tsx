...
const MODES: { value: SessionMode; icon: string; title: string; blurb: string }[] = [
  { value: 'in_person', icon: '📍', title: 'In person', blurb: 'Meet at a café, library, or campus' },
  { value: 'online', icon: '💻', title: 'Online room', blurb: 'Live virtual classroom with avatars' },
]
